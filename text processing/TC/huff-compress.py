...
# ID: 180127472
###############################################################################
import argparse, re, array, bisect, pickle, os.path, time
...
class HuffmanCompress:
    ...
    def code_tree(self):
        ...
        while len(nodes) > 1:
            ...
            keys_bisect.insert(new_index, new_count)

            del keys_bisect[0], keys_bisect[1]
            nodes.remove(temp1), nodes.remove(temp2)
...
print('Time for building model: {}'.format(time.time()-t))
